...
\end{equation}
Integrating this curved metric yields the true, information-scaled physical distance $S(x) = 2\tau_0\sqrt{x}$ \cite{jacobson1995}. The cosmological redshift is therefore not a pure Doppler effect of recessional velocity, but an accumulated phase shift within the curved, self-reactive number space \cite{riemann1857}.
